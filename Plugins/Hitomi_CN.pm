package LANraragi::Plugin::Metadata::Hitomi_CN;
...
sub plugin_info {
    ...
    return (
        ...
        name        => "Hitomi_CN",
        type        => "metadata",
        namespace   => "hitomiplugincn",
        author      => "doublewelp & zizzdog",
        version     => "0.3_1",
        description => "搜索标题中的Hitomi.la画廊ID,以查找与您的存档匹配的标签.
                        <br>并将原标签翻译为中文标签. 
                        <br/><i class='fa fa-exclamation-circle'></i> 否则插件将使用存档的 source: tag （如果存在）",
        parameters  => [
            { type  => "string", desc => "EhTagTranslation项目的JSON数据库文件(db.text.json)的绝对路径" }
        ],
        oneshot_arg => "USE the url to match tags: https://hitomi.la/XXXXX/XXXXX",
        cooldown    => 4,
        icon        =>
